...
typedef struct {
    char fileName;
    int fileSize;
    // this vector will keep track of non-contiguous blocks of memory allocated to each file
    // each element will correspond to location of a block (containing fileName), with starting and ending index.
